        ...
        function menu_initializer() {
            ...
            <form method="POST" action="" style="width: 100%;" id="ubcar-add-new-form">
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row"><label for="ubcar_layer_title">Layer Title</label></th>
                        <td><input name="ubcar_layer_title" type="text" id="ubcar_layer_title" value="" class="regular-text ltr" /></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="ubcar_layer_description">Layer Description Text</label></th>
                        <td>
                            <textarea name="ubcar_layer_description" rows="5" type="textfield" id="ubcar_layer_description" value="" class="regular-text ltr" /></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="ubcar_layer_password">Block Subscriber-Level Media Access:</label></th>
                        <td>
                        <input name="ubcar_layer_password" id="ubcar_layer_password" type="checkbox"></td></td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <div class="button button-primary" name="ubcar_layer_submit" id="ubcar_layer_submit">Upload Layer</div>
                        </th>
                    </tr>
                </table>
            </form>
            ...
            <table class="ubcar-table" id="ubcar_layer_table">
            </table>
            <div class="ubcar-forward-back">
                <a class="ubcar-forward-back-control" id="ubcar_layer_back">Prev</a>
                <span id="ubcar_layer_display_count">1</span>
                <a class="ubcar-forward-back-control" id="ubcar_layer_forward">Next</a>
            </div>
            <?php
        }
