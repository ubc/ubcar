        ...
        function menu_initializer() {
            ...
            <form method="POST" action="" style="width: 100%;" id="ubcar-add-new-form">
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row"><label for="ubcar_tour_title">Tour Title</label></th>
                        <td><input name="ubcar_tour_title" type="text" id="ubcar_tour_title" value="" class="regular-text ltr" /></td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="ubcar_tour_description">Tour Description Text</label></th>
                        <td>
                            <textarea name="ubcar_tour_description" rows="5" type="textfield" id="ubcar_tour_description" value="" class="regular-text ltr" /></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label for="ubcar_tour_locations">Tour Locations</label></th>
                        <td>
                    ...
                    <tr>
                        <th scope="row">
                            <div class="button button-primary" name="ubcar_tour_submit" id="ubcar_tour_submit">Upload Tour</div>
                        </th>
                    </tr>
                </table>
            </form>
            ...
            <div>
                <table class="ubcar-table" id="ubcar_tour_table">
                </table>
                <div class="ubcar-forward-back">
                    <a class="ubcar-forward-back-control" id="ubcar_tour_back">Prev</a>
                    <span id="ubcar_tour_display_count">1</span>
                    <a class="ubcar-forward-back-control" id="ubcar_tour_forward">Next</a>
                </div>
            </div>
            <?php
        }
