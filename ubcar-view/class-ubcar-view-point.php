<?php
	 ...
	 * The UBCAR_View_map subclass
	 */
    class UBCAR_View_Point extends UBCAR_View {
		...
		function add_scripts() {
			...
			wp_register_script( 'ubcar_map_display_app_script', plugins_url( 'js/ubcar-map-app-view.js', dirname( __FILE__ ) ) );
			wp_enqueue_script( 'ubcar_map_display_toggles_script', array( 'jquery' ) );
			wp_enqueue_script( 'ubcar_map_display_app_script', array( 'jquery', 'ubcar_map_display_toggles_script' ) );
			wp_enqueue_script( 'jquery-effects-drop', array( 'jquery' ) );
			wp_localize_script( 'ubcar_map_display_app_script', 'ajax_object', array( 'ajax_url' => admin_url( 'admin-ajax.php' ) ) );
      ...
      wp_register_style( 'ubcar_control_panel_style', plugins_url( '/css/ubcar-admin-style.css', dirname( __FILE__ ) ) );
		...
		function add_styles() {
            ...
            wp_register_style( 'ubcar_view_app_style', plugins_url( 'css/ubcar-view-full-app.css', dirname( __FILE__ ) ) );
            wp_enqueue_style( 'ubcar_view_app_style' );
		}
        ...
        <div class="ubcar-informational-right-column">
          ...
          <div class="ubcar-body" id="ubcar-body-media-submit">
